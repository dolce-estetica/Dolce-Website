 ...
 * Sep 2026). One config below = one landing page at /lp/<slug>. The page
...
const WHY = [
  {
    title: "A doctor sees you first",
    text: "No treatment is recommended before a qualified doctor has examined you and understood your history. The plan follows the assessment — never the other way round.",
  },
  {
    title: "Honest, consultation-first advice",
    text: "If a concern will settle on its own, or a treatment is not right for you, we say so. We would rather lose a sale than your trust.",
  },
  {
    title: "Four clinics, one standard",
    text: "The same doctors, protocols and clinical standards at Edapally (Kochi), Cherthala, Calicut and Mangalore — whichever is closest to you.",
  },
  {
    title: "Transparent, itemised pricing",
    text: "You receive the complete cost in writing at your consultation, before anything begins. No hidden add-ons, no surprise line items later.",
  },
];
...
export const landingPages: LandingPage[] = [
   ...
   * ================================================================== */
  {
    ...
    why: WHY,
    services: {
      heading: "What our dermatologists treat",
      intro:
    ...
    results: {
      ...
      text: "Photos of consented patients with concerns like yours are shown at your consultation, in person. We do not publish stock or AI-generated before/after images — what you see at the clinic is real, and your own results depend on your diagnosis, skin type and the plan you choose.",
      pairs: [],
    },
    concerns: [
      "Acne or acne scars",
   ...
   * ================================================================== */
  {
    ...
    why: WHY,
    services: {
      heading: "What a HydraFacial does",
      intro:
   ...
   * ================================================================== */
  {
    ...
    services: {
      ...
      intro:
        "IV glutathione works from within, alongside — never instead of — proper diagnosis and sun protection. Your doctor confirms suitability before the first session.",
      items: [
        {
   ...
   * ================================================================== */
  {
    ...
    impact: [
      ...
      { value: "Medlounges", label: "Body contouring specialists, Kerala" },
      { value: "Group clinics", label: "Same leadership as Dolce Estetica" },
      { value: "Itemised", label: "Full surgical quote in writing" },
    ],
    why: [
      {
        title: "A surgical consultation, not a sales one",
        text: "VASER liposuction is surgery. A surgeon examines you, reviews your health history and tells you plainly whether you are a candidate — including when the honest answer is 'not yet' or 'not at all'.",
      },
      {
        title: "Body contouring is our heritage",
        text: "Medlounges has years of experience in surgical aesthetics and body contouring in Kerala, under the same medical leadership as Dolce Estetica — a doctor-led group, not a franchise.",
      },
      {
        title: "Contouring, honestly framed",
        text: "VASER reshapes areas of stubborn fat — it is not a weight-loss treatment and not a substitute for a healthy lifestyle. We tell you what it can and cannot do before you commit to anything.",
      },
      {
        title: "The full quote, in writing, before surgery",
        text: "The complete surgical cost — procedure, anaesthesia, facility and aftercare — is given as one itemised figure after your consultation. Nothing is added after you decide.",
      },
    ],
    services: {
